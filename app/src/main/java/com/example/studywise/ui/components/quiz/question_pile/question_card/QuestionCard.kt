...
import com.example.studywise.ui.components.quiz.question_pile.question_card.answer.AnswerOptionCard
    ...
    AppTheme() {
        QuestionCard(
            state = QuestionCardUiState(
                ...
                answers = listOf(
                    AnswerUiState(text = "2", id = "1", isCorrect = true),
                    AnswerUiState(text = "4", id = "2", isCorrect = false),
                    AnswerUiState(text = "6", id = "2", isCorrect = false),
                    AnswerUiState(text = "8", id = "2", isCorrect = false)
                )
            ),
            modifier = Modifier
                .padding(32.dp),
